...
var Main = (0, _theming.styled)(function (_ref4) {
  var msg = _ref4.msg,
...
var colorizeText = function colorizeText(msg, type) {
  if (type) {
    return msg.split(type === positiveType ? positiveConsoleRegex : negativeConsoleRegex).map(function (i, index) {
      return index % 2 ? _react["default"].createElement(StatusColor, {
...
var getTestDetail = function getTestDetail(msg) {
  ...
  for (var index = 1; index < lines.length; index += 1) {
    ...
    if (current.trim().toLowerCase().indexOf(stackTraceStartToken) === 0) {
      ...
      testDetail.result = [].concat(_toConsumableArray(testDetail.result), [title, ' '], _toConsumableArray(value), [_react["default"].createElement("br", {
        key: index
      })]);
    } else {
...
var Message = function Message(props) {
  ...
  return _react["default"].createElement(_react.Fragment, null, detail.description ? _react["default"].createElement(Description, null, detail.description) : null, detail.result ? _react["default"].createElement(Results, null, detail.result) : null, detail.stackTrace ? _react["default"].createElement(StackTrace, null, detail.stackTrace) : null);
};
