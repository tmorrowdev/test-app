...
function Result(props) {
  ...
  return _react["default"].createElement(_react.Fragment, null, _react["default"].createElement(Wrapper, {
    status: status
  }, _react["default"].createElement(HeaderBar, {
    onClick: onToggle,
    role: "button",
    status: status
  }, status === "failed" ? _react["default"].createElement(Icon, {
    icon: "chevrondown",
    size: 10,
  ...
  }) : null, _react["default"].createElement("div", null, capitalizeFirstLetter(fullName) || capitalizeFirstLetter(title)))), isOpen ? _react["default"].createElement(_react.Fragment, null, failureMessages.map(function (msg, i) {
