...
function useArgs() {
  ...
  var updateArgs = useCallback(function (newArgs) {
    return channel.emit(_coreEvents.UPDATE_STORY_ARGS, storyId, newArgs);
  }, [channel, storyId]);
...
function useGlobalArgs() {
  ...
  var _useStoryContext3 = useStoryContext(),
      globalArgs = _useStoryContext3.globalArgs;

  var updateGlobalArgs = useCallback(function (newGlobalArgs) {
    return channel.emit(_coreEvents.UPDATE_GLOBAL_ARGS, newGlobalArgs);
  }, [channel]);
