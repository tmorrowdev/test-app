...
var warnUsingHierarchySeparatorsAndShowRoots = (0, _utilDeprecate["default"])(function () {}, (0, _tsDedent["default"])(_templateObject()));
var warnRemovingHierarchySeparators = (0, _utilDeprecate["default"])(function () {}, (0, _tsDedent["default"])(_templateObject2()));
var warnChangingDefaultHierarchySeparators = (0, _utilDeprecate["default"])(function () {}, (0, _tsDedent["default"])(_templateObject3()));
...
var denormalizeStoryParameters = function denormalizeStoryParameters(_ref) {
  ...
  return (0, _lodash.mapValues)(stories, function (storyData) {
    return Object.assign(Object.assign({}, storyData), {}, {
...
var transformStoriesRawToStoriesHash = function transformStoriesRawToStoriesHash(input, base, _ref2) {
  ...
  var storiesHashOutOfOrder = Object.values(input).filter(Boolean).reduce(function (acc, item) {
    ...
    var _provider$getConfig = Object.assign(Object.assign({}, provider.getConfig()), parameters && parameters.options || {}),
        _provider$getConfig$h = _provider$getConfig.hierarchyRootSeparator,
        rootSeparator = _provider$getConfig$h === void 0 ? undefined : _provider$getConfig$h,
        _provider$getConfig$h2 = _provider$getConfig.hierarchySeparator,
        groupSeparator = _provider$getConfig$h2 === void 0 ? undefined : _provider$getConfig$h2,
        _provider$getConfig$s = _provider$getConfig.showRoots,
        showRoots = _provider$getConfig$s === void 0 ? undefined : _provider$getConfig$s;

    var usingShowRoots = typeof showRoots !== 'undefined'; // Kind splitting behavior as per https://github.com/storybookjs/storybook/issues/8793

    var root = '';
    var groups; // 1. If the user has passed separators, use the old behavior but warn them
    ...
    .reduce(function (soFar, group, index, original) {
      ...
      if (parent === id) {
        throw new Error((0, _tsDedent["default"])(_templateObject4(), name, id, kind));
      }

      if (!!root && index === 0) {
        var _result = Object.assign(Object.assign({}, group), {}, {
          id: id,
          depth: index,
          children: [],
          isComponent: false,
      ...
      var result = Object.assign(Object.assign({}, group), {}, {
        id: id,
        parent: parent,
        depth: index,
        children: [],
    ...
    rootAndGroups.forEach(function (group, index) {
      ...
      var id = group.id;
      acc[id] = (0, _merge["default"])(acc[id] || {}, Object.assign(Object.assign({}, group), child && {
        children: [child]
      }));
    });
    var story = Object.assign(Object.assign({}, item), {}, {
  ...
  return Object.values(storiesHashOutOfOrder).reduce(addItem, Object.assign({}, base));
};
