...
export declare type State = layout.SubState & stories.SubState & refs.SubState & notifications.SubState & version.SubState & url.SubState & shortcuts.SubState & globalArgs.SubState & RouterData & Other;
export declare type API = addons.SubAPI & channel.SubAPI & provider.SubAPI & stories.SubAPI & refs.SubAPI & globalArgs.SubAPI & layout.SubAPI & notifications.SubAPI & shortcuts.SubAPI & version.SubAPI & url.SubAPI & Other;
interface Other {
    [key: string]: any;
}
...
export { ManagerConsumer as Consumer, ManagerProvider as Provider, StoriesHash, Story, Root, Group, isGroup, isRoot, isStory, };
...
export declare function useArgs(): [Args, (newArgs: Args) => void];
export declare function useGlobalArgs(): [Args, (newGlobalArgs: Args) => void];
export declare function useArgTypes(): ArgTypes;
export declare function useGlobalArgTypes(): ArgTypes;
