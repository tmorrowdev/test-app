...
var createColors = function createColors(vars) {
  return {
    ...
    // Monochrome
    lightest: vars.base === 'dark' ? _base.color.darkest : _base.color.lightest,
    lighter: vars.base === 'dark' ? _base.color.darker : _base.color.lighter,
    light: vars.base === 'dark' ? _base.color.dark : _base.color.light,
    mediumlight: vars.base === 'dark' ? _base.color.mediumdark : _base.color.mediumlight,
    medium: _base.color.medium,
    mediumdark: vars.base === 'dark' ? _base.color.mediumlight : _base.color.mediumdark,
    dark: vars.base === 'dark' ? _base.color.light : _base.color.dark,
    darker: vars.base === 'dark' ? _base.color.lighter : _base.color.darker,
    darkest: vars.base === 'dark' ? _base.color.lightest : _base.color.darkest,
    // For borders
...
var convert = function convert() {
  ...
  return Object.assign(Object.assign({}, rest || {}), {}, {
    ...
    addonActionsTheme: Object.assign(Object.assign({}, base === 'light' ? _syntax.chromeLight : _syntax.chromeDark), {}, {
