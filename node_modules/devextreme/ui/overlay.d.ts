...
/** Warning! This type is used for internal purposes. Do not import it directly. *//** The Overlay widget represents a window overlaying the current view. It displays data located within the HTML element representing the widget. */
