...
@SCHEDULER_MONTH_WORKSPACE_ROWS_COUNT: 6;
@SCHEDULER_MONTH_WORKSPACE_DATE_TABLE_HEIGHT: @SCHEDULER_WORKSPACE_DATE_TABLE_CELL_HEIGHT * @SCHEDULER_MONTH_WORKSPACE_ROWS_COUNT;
...
@SCHEDULER_AGENDA_APPOINTMENT_MARGIN: 5px;
@SCHEDULER_AGENDA_LAST_IN_DATE_APPOINTMENT_MARGIN: 20px;
@SCHEDULER_AGENDA_APPOINTMENT_FONT_SIZE: 16px;
@SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH: 70px;
...
.set-offset-agenda-group-mixin(@offset) {
    .dx-scheduler-date-table {
        margin-right: -@offset - @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;
        ...
        .dx-rtl & {
            margin-left: -@offset - @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;
    ...
    .dx-scheduler-scrollable-appointments {
        padding-left: @offset + @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;

        .dx-scheduler-small & {
            padding-left: @offset * @SCHEDULER_SMALL_SIZE_FACTOR + @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH * @SCHEDULER_SMALL_SIZE_FACTOR;
        }

        .dx-rtl & {
            padding-left: 0;
            padding-right: @offset + @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;

            .dx-scheduler-small & {
                padding-right: @offset * @SCHEDULER_SMALL_SIZE_FACTOR + @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH * @SCHEDULER_SMALL_SIZE_FACTOR;
            }
        }
    }
}
...
.dx-scheduler-agenda-group-mixin(@offset) {
    ...
    &[dx-group-column-count='2'] {
        .set-offset-agenda-group-mixin(@offset * 2);
    }

    &[dx-group-column-count='3'] {
        .set-offset-agenda-group-mixin(@offset * 3);
    }
}
...
.set-size-timeline-horizontal-grouping-mixin(@size) {
...
.dx-scheduler-timeline-horizontal-grouping-mixin(@baseHeight) {
    &.dx-scheduler-work-space {
        &[dx-group-row-count='1'] {
            .set-size-timeline-horizontal-grouping-mixin(@baseHeight + 40px);
        }

        &[dx-group-row-count='2'] {
            .set-size-timeline-horizontal-grouping-mixin(@baseHeight + 80px);
        }

        &[dx-group-row-count='3'] {
            .set-size-timeline-horizontal-grouping-mixin(@baseHeight + 120px);
        }
    }
}

.set-size-timeline-group-table-mixin(@size) {
...
.dx-scheduler-timeline-group-table-mixin() {
    ...
    &[dx-group-column-count='1'] {
        .set-size-timeline-group-table-mixin(100px);
    }

    &[dx-group-column-count='2'] {
        .set-size-timeline-group-table-mixin(160px);
    }

    &[dx-group-column-count='3'] {
        .set-size-timeline-group-table-mixin(240px);
    }
}

.set-size-vertical-group-table-mixin(@size, @offset) {
...
.dx-scheduler-vertical-group-table-mixin(@offset: 0px) {
    &[dx-group-column-count='1'] {
        .set-size-vertical-group-table-mixin(@SCHEDULER_LEFT_COLUMN_WIDTH, @offset);
    }

    &[dx-group-column-count='2'] {
        .set-size-vertical-group-table-mixin(1.5 * @SCHEDULER_LEFT_COLUMN_WIDTH, @offset);
    }

    &[dx-group-column-count='3'] {
        .set-size-vertical-group-table-mixin(2 * @SCHEDULER_LEFT_COLUMN_WIDTH, @offset);
    }
}
...
.dx-scheduler-appointment-focused-mixin() {
    &.dx-state-focused {
        ...
        // T314382
        & when (@SCHEDULER_FILL_FOCUSED_APPOINTMENT) {
        ...
        &:before {
            ...
            // T314382
            & when not (@SCHEDULER_FILL_FOCUSED_APPOINTMENT) {
                background-color: @SCHEDULER_APPOINTMENT_START_COLOR;
                opacity: 0.98;
            }
        }
...
.dx-scheduler-pseudo-cell-mixin() {
    &:before {
        content: "";
...
.scheduler-mixin() {
    ...
    .dx-scheduler-work-space-month {
        ...
        .dx-scheduler-date-table-scrollable .dx-scrollable-content {
            min-height: @SCHEDULER_MONTH_WORKSPACE_DATE_TABLE_HEIGHT;
        }
    ...
    .dx-scheduler-timeline { // stylelint-disable-line no-duplicate-selectors
        ...
        .dx-scheduler-date-table { // stylelint-disable-line no-duplicate-selectors
            ...
            .dx-scheduler-date-table-cell {
                ...
                flex: 1 1 auto;
                height: inherit;
                min-height: @SCHEDULER_WORKSPACE_DATE_TABLE_CELL_HEIGHT;
            }
        }
    ...
    .dx-scheduler-date-table {
        ...
        .dx-scheduler-agenda & {
            margin-left: -@SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;
        }
    }
    ...
    .dx-scheduler-agenda {
        ...
        .dx-scheduler-scrollable-appointments {
            padding-left: @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;

            .dx-scheduler-small & {
                &.dx-rtl {
                    padding-left: 0;
                    padding-right: @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH * @SCHEDULER_SMALL_SIZE_FACTOR;
                }

                padding-left: @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH  * @SCHEDULER_SMALL_SIZE_FACTOR;
            }
        ...
        .dx-scheduler-time-panel {
            margin-top: 0;
            width: @SCHEDULER_AGENDA_LEFT_COLUMN_WIDTH;
        }
        ...
        .dx-scheduler-appointment {
            position: relative;
            box-shadow: none;
            margin-top: @SCHEDULER_AGENDA_APPOINTMENT_MARGIN;
            margin-bottom: @SCHEDULER_AGENDA_APPOINTMENT_MARGIN;

            &.dx-scheduler-last-in-date-agenda-appointment {
                margin-bottom: @SCHEDULER_AGENDA_LAST_IN_DATE_APPOINTMENT_MARGIN;
            }
        }
