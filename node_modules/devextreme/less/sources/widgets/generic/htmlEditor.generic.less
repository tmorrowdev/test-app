...
@GENERIC_HTML_EDITOR_TOOLBAR_HEIGHT: @GENERIC_BASE_INLINE_WIDGET_HEIGHT;
@GENERIC_MOBILE_HTML_EDITOR_TOOLBAR_HEIGHT: @GENERIC_MOBILE_BASE_INLINE_WIDGET_SIZE;
...
.dx-htmleditor-toolbar {
    ...
    .dx-htmleditor-toolbar-separator {
        height: @GENERIC_HTML_EDITOR_TOOLBAR_HEIGHT;

        .dx-device-mobile & {
            height: @GENERIC_MOBILE_HTML_EDITOR_TOOLBAR_HEIGHT;
        }
    }
}
