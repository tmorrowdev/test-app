...
@base-bg: #000;
@base-inverted-bg: difference(#fff, @base-bg);
...
@base-inverted-text-color: difference(#fff, @base-text-color);
@base-inverted-icon-color: difference(#fff, @base-text-color);
...
@base-dropdown-shadow-color: @base-shadow-color;
...
@gallery-indicator-selected-border-color: difference(#fff, @base-border-color);
...
@htmleditor-mention-bg: difference(#fff, @base-bg);
...
// TagBox
@tagbox-tag-bg: difference(#fff, @base-bg);
...
// NavBar
@navbar-tab-selected-bg: difference(#fff, @base-bg);
...
@slider-handle-border-color: difference(#fff, @base-border-color);
...
@scheduler-appointment-focus-color: difference(#fff, @base-text-color);
...
@SCHEDULER_WORKSPACE_HOVERED_CELL_COLOR: difference(#fff, @base-text-color);
...
@numberbox-spin-active-color: difference(#fff, @base-border-color);
...
@filemanager-file-item-select-bg: fade(@base-accent, 80%);
@filemanager-file-item-select-focus-color: @base-bg;
@filemanager-file-item-select-focus-bg: fade(@base-accent, 70%);
@filemanager-file-item-hover-bg: @base-hover-color;
@filemanager-file-item-focused-bg: @base-accent;
@filemanager-file-item-focused-border: @base-accent;
@filemanager-item-focused-color: @base-text-color;
