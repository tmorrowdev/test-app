...
type ProjectionMethods = {
   /** Adds a new projection to the internal projection storage. */
    ...
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Gets a predefined or custom projection from the projection storage. */
    get(name: 'equirectangular' | 'lambert' | 'mercator' | 'miller' | string): any;
}

/** Warning! This type is used for internal purposes. Do not import it directly. *//** Creates a new projection. */
