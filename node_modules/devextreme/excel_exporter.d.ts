...
export interface ExportLoadPanel {
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies whether the load panel is enabled. */
    enabled?: boolean;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies text displayed on the load panel. */
    text?: string;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies the width of the load panel in pixels. */
    width?: number;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies the height of the load panel in pixels. */
    height?: number;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies whether to show the loading indicator. */
    showIndicator?: boolean;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies a URL pointing to an image to be used as a loading indicator. */
    indicatorSrc?: string;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies whether to show the pane of the load panel. */
    showPane?: boolean;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies whether to shade the widget when the load panel is shown. */
    shading?: boolean;
    /** Warning! This type is used for internal purposes. Do not import it directly. *//** Specifies the shading color. Applies only if shading is true. */
    shadingColor?: string;
}
